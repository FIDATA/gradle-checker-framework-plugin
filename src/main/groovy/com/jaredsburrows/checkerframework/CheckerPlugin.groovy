...
final class CheckerPlugin implements Plugin<Project> {
  ...
  public final static String ANNOTATED_JDK_CONFIGURATION = 'checkerFrameworkAnnotatedJDK'
  ...
  public final static String JAVAC_CONFIGURATION = 'checkerFrameworkJavac'
  ...
  public final static String CONFIGURATION = 'checkerFramework'
  private final static String CONFIGURATION_DESCRIPTION = 'The Checker Framework: custom pluggable types for Java.'
  public final static String ANNOTATION_PROCESSOR_CONFIGURATION = 'annotationProcessor'
  public final static String TEST_ANNOTATION_PROCESSOR_CONFIGURATION = 'testAnnotationProcessor'
  public final static String JAVA_COMPILE_CONFIGURATION = 'compile'
